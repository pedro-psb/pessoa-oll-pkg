\version "2.19.82"
#(define-public melodia_default 
   '((_style . ((kkopen	default	#f   3)
...
#(define-public dundun_default 
   '((_style . ((kkopen	default	#f   0)
...
#(define-public two-dundun_default 
   '((_style . ((kkopen	default	#f   2)
...
#(define-public djembe_default 
   '((_style . ((djslap		default	#f		3)
